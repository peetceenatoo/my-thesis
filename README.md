...
This project studies online bilateral trade through the lens of regret minimization, with a focus on a **strong distributional benchmark** under **global budget balance**.
